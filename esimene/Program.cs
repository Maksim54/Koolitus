...
Kutsekooliopilane Kutsekooliopilane = new Kutsekooliopilane("THK", "Viimsi", 460, 3, 4.2, "Tarkvaraarendaja", 2, 60, "TARpv21", "Tarkvaraarendaja", "Daniel", 2005, Isik.sugu.mees, 0,0);
tootaja.printInfo();
